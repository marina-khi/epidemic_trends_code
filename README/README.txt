...
"Nonparametric comparison of epidemic trends: the case of COVID-19"
...
The main file for size and power simulations (main_sim.r) is divided into several blocks, each block being responsible for one part of the calculations with either a table as a figure result.
...
All programs are written in R (with some function written in C). They are all quite self-explanatory and commented. The code is self-sufficient. 
